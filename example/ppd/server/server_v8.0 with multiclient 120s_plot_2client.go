		...
		if len(dash_data_split) > 3 && dash_data_split[0] == req_data_map["did"] {
			...
			if Timer_global > 120 {
				...
				if plot_if == 1 {
					...
					str3 := "client3"
					// str4 := "client4"
					plotutil.AddLinePoints(p, str1, pts1, str3, pts3)
					plotutil.AddLinePoints(p2, str1, pts1_2, str3, pts3_2)
					p.Save(4*vg.Inch, 4*vg.Inch, "QoE2clients.png")
					p2.Save(4*vg.Inch, 4*vg.Inch, "Bandwidth2clients.png")
