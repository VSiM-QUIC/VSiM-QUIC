...
func main() {
	...
	http.HandleFunc("/", func(w http.ResponseWriter, r *http.Request) {
		...
		if len(dash_data_split) > 3 && dash_data_split[0] == req_data_map["did"] {
			...
			qoe_new := CurrentBitrate - beta*(0-BufferTime) - 0.1*smoothness
			...
			if Timer_global > 260 {
				...
				fmt.Println("precache", " beta=", beta, "update frequency:", updateFreq, "avg_bandwidth", avg_bandwidth)
		...
		avg_bandwidth = 3.5
		var bandwidth_default = float64(1024*768) / 6 * avg_bandwidth
